...
const (
	_getSwaggerGen = "go get -u github.com/gisvr/go-tools/protobuf/protoc-gen-bswagger"
	_swaggerProtoc = "protoc --proto_path=%s --proto_path=%s --proto_path=%s --proto_path=%s --bswagger_out=:."
)
