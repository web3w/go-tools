...
const (
	_getEcodeGen = "go get -u github.com/gisvr/go-tools/protobuf/protoc-gen-ecode"
	_ecodeProtoc = "protoc --proto_path=%s --proto_path=%s --proto_path=%s --proto_path=%s --ecode_out=:."
)
