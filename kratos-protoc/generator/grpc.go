...
const (
	...
	_getGRPCGen = "go get -u github.com/gogo/protobuf/protoc-gen-gogofaster"
	_grpcProtoc = `protoc --proto_path=%s --proto_path=%s --proto_path=%s --proto_path=%s --gogofaster_out=plugins=grpc:.`
)
